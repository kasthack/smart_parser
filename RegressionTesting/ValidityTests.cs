...
namespace RegressionTesting
{
    ...
    public class ValidityTests
    {
        ...
        public void TestSmartParserMultipleOut(AdapterFamily adapterName, string filename, params string[] outfiles)
        {
            SetupLog4Net();
            ...
            Smart.Parser.Program.CurrentOptions.Adapter = adapterName;
            Smart.Parser.Program.CurrentOptions.SkipRelativeOrphan = false;
        ...
        public void TestSmartParser(string filename, AdapterFamily adapterName, 
            bool skipRelativeOrphan = false, SmartParserJsonFormatEnum jsonFormat = SmartParserJsonFormatEnum.Official)
        {
            ...
            Log(SmartParserLogFile,
                String.Format("run smart_parser on {0} in directory {1}", filename, Directory.GetCurrentDirectory()));
            Smart.Parser.Program.CurrentOptions.Adapter = adapterName;
            Smart.Parser.Program.CurrentOptions.SkipRelativeOrphan = skipRelativeOrphan;
        ...
        {
            TestSmartParser("MinDalVostok2015.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            // from pdf
            TestSmartParser("one_line_2017.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("SpellCheckRealtyType.docx", AdapterFamily.Prod);
        }
        ...
        {
            // from pdf
            TestSmartParser("two_tables_2017.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("IncomeNotFirstLine.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("4067_0.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("256_Columns.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("minfin2016.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("minzdrav2015.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinSport2016.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinRes2011.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinYust2012.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("DepEnergo2010.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("28733.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinZdorov2015Full.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinEkon2013.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinStroy2014.docx", AdapterFamily.Prod);
        }
        ...
        public void MinObr2012()
        {
            ...
            TestSmartParser("MinObr2012.docx", AdapterFamily.Prod);
        }
        ...
        {
            // в этом тесте есть ошибка, последний обеъек не парсится
            TestSmartParser("MinTrans2011.docx", AdapterFamily.Prod);
        }
        ...
        public void MinSevKavkaz2015()
        {
            ...
            TestSmartParser("MinSevKavkaz2015.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinObr2016.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("fsin2013.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinStroy2017.xlsx", AdapterFamily.Prod);
        }
        ...
        public void MinStroy2017_1()
        {
            ...
            TestSmartParser("MinStroy2017_1.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinEkonon2017.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("toloka.toloka_json", AdapterFamily.Prod, true);
        }
        ...
        public void Unk2014()
        {
            TestSmartParser("Unk2014.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("17207.xls", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("section_example.toloka_json", AdapterFamily.Prod, true);
        }
        ...
        {
            TestSmartParser("MinKult2015.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinDalVostok2017.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParserMultipleOut(AdapterFamily.Prod,
        ...
        {
            TestSmartParser("Spasat2016.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("DepGosPol2012.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("30429.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("RealtyNaturalText.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("8562.pdf.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("HeaderInsideTable.docx", AdapterFamily.Prod);
        }
        ...
        public void dnko2014()
        {
            ...
            TestSmartParser("dnko-2014.docx", AdapterFamily.Prod);
        }
        ...
        {
            // Column shift
            TestSmartParser("ZagranApp2016.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("BadColumns.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinKult2012.docx", AdapterFamily.Prod);
        }
        ...
        public void MinKult2011()
        {
            ...
            TestSmartParser("MinKult2011.doc", AdapterFamily.Prod, true);
        }
        ...
        {
            // повтор Header внутри таблицы
            TestSmartParser("MinSelhoz2015.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("Fsin2011.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinEkonom2014.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("33793.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinProm2013.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinSelhoz2013.xlsx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("ZabSud2017.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("Mchs2010.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinObor2012.xls", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("Mchs2013.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinTrans2009.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinKult2015.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinKult2012.doc", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MinEkon2015.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("Sudia2011.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("7007_10.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("gorshkova_20190706002511.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("4002_0.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("BadOcr.pdf.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("17335_3.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("17339_24.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("4144_28.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("4037_9.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("4778_0.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("16694.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("17497.xls", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("16738_12.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("15555_1.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("15555_0.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("7007_8.html", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("7022_0.htm", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("Deputy2015.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("MainWorkPositionIncome.docx", AdapterFamily.Prod);
        }
        ...
        {
            TestSmartParser("disclosures_format.xls", AdapterFamily.Prod, false, SmartParserJsonFormatEnum.Disclosures);
        }
